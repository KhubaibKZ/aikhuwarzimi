...
export const questions4024_12_2023ON: Record<string, PastPaperQuestion> = {
  ...
  'pp_4024_on23_12_q14': {
    ...
    type: 'multi-part',
    diagramParts: ['b', 'c'],
    parts: [{ label: '(a) Angle ABC (°)', key: 'a', marks: 1 }, { label: '(b) Construction (on diagram)', key: 'b', marks: 2, diagramScored: true } as any, { label: '(c) Shaded region (on diagram)', key: 'c', marks: 2, diagramScored: true } as any],
