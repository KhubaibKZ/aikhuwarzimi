...
const TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    title: 'Answer part (a)',
    body: 'Type your answer for 6 + 4 ÷ 2 in this box.',
    placement: 'bottom',
    interaction: 'input',
  },
  {
    ...
    title: 'Check part (a)',
    body: 'Tap Check Work to get instant feedback on your first answer.',
    placement: 'left',
    interaction: 'click',
  },
  {
    ...
    title: 'Answer part (b)',
    body: 'Now type the answer for 40 × 0.3 in the second box.',
    placement: 'bottom',
    interaction: 'input',
  },
  {
